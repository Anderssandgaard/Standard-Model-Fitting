...
%            EstimatedTimeNeeded = (UsedTime_now-Obj.UsedTime_1)/Obj.ReportInterval*(Obj.TotalMessage-Obj.NumMessage);
           EstimatedTimeNeeded = UsedTime_now/Obj.NumMessage*(Obj.TotalMessage-Obj.NumMessage);
           waitbar(Obj.NumMessage/Obj.TotalMessage, Obj.WaitbarHandle, [num2str(Obj.NumMessage/Obj.TotalMessage*100, '%.0f'), '%; ', num2str(UsedTime_now, '%.0f'), 's used and ', num2str(EstimatedTimeNeeded, '%.0f'), 's needed.']);
